...
export default function ListingItem({ listItem }) {
  // image, location name, nightly rate, or any other details might be useful
  return (
    <main className='py-6 rounded-lg'>
      <Link href={`/listing/${listItem.info.id}`}>
        <div class='grid grid-cols-1'>
          <div class='grid col-start-1 col-end-5 row-start-1'>
            <div className=''>
              <img
                src={listItem.info.mainImage.url}
                alt=''
                class='w-full h-60 md:h-96 object-cover rounded-lg col-span-full'
                loading='lazy'
              />
              {listItem.info.host && (
                <div className='flex flex-row justify-between ml-2'>
                  <div className='flex flex-row'>
                    <div>
                      <img
                        src={listItem.info.host.avatar.url}
                        alt=''
                    ...
                    <div>
                      <p className='my-6 ml-2'>{listItem.info.host.name}</p>
                    </div>
                  </div>
                </div>
              )}
            ...
            <dl class='mt-1 text-xs font-medium flex items-center row-start-3'>
              ...
              <dd class='flex items-center'>
                ...
                {listItem.info.location.city +
                  ', ' +
                  listItem.info.location.country.title}
              </dd>
            </dl>
            <dl class='mt-3 text-xs font-medium flex items-center row-start-4 ml-1'>
              ...
              <dd class='text-black flex items-center'>
                ...
                <span className='text-sm ml-2'>
                  {listItem.info.maxGuestCapacity}
                </span>
              </dd>
              ...
              <dd class='text-black flex items-center'>
                ...
                <span className='text-sm ml-2'>
                  {listItem.info.ratings.guestSatisfactionOverall}{' '}
                </span>
              </dd>
              ...
              <dd class='text-black flex items-center'>
                ...
                <span className='text-sm ml-2'>
                  {listItem.info.visibleReviewCount}{' '}
                </span>
              </dd>
            </dl>
          </div>
